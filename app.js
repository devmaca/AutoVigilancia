...
const route_conductor = require('./routes/conductor')
const route_operador = require('./routes/operador')
const mongoURI = `mongodb+srv://mac1:eucalipto@cluster0.wc1ua.mongodb.net/myfirstdb?retryWrites=true&w=majority`;
var mongoose = require('mongoose');
mongoose.connect(mongoURI, { useNewUrlParser: true });

//mongoose.connect('mongodb://127.0.0.1:27017/caseNueva1', { useNewUrlParser: true });
...
app.use('/conductor', route_conductor);
app.use('/operador', route_operador);
